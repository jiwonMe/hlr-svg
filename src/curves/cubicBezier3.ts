...
export function evalCubic3(b: CubicBezier3, t: number): Vec3 {
  // de Casteljau
...
export function splitCubic3(b: CubicBezier3, t: number): { left: CubicBezier3; right: CubicBezier3 } {
